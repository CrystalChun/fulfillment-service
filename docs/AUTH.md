...
**Permissions:** Full access to all methods (lines 316-319 in `authz.rego`)
...
**Authorization:** Enforced via OPA policy (lines 349-359 in `authz.rego`)
...
**Authorization:** Enforced via OPA policy (lines 336-346 in `authz.rego`)
