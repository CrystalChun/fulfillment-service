...
type Role struct {
	...
	Description     string
	Composite       bool
	ApplicationRole bool   // true if application-level, false if organization-level
	ContainerID     string // The ID of the organization or application that contains this role
	Attributes      map[string][]string
}
