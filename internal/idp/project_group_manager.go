...
//go:generate go run go.uber.org/mock/mockgen -destination=project_group_manager_mock.go -package=idp . ProjectGroupManagerInterface
...
// ProjectGroupManagerInterface defines the interface for project group management operations.
type ProjectGroupManagerInterface interface {
