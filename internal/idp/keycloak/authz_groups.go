...
func (c *Client) getGroupIDByPathWithOrgID(ctx context.Context, orgID, groupPath string) (string, error) {
	...
	// Search for the group by path (non-recursive for now since we only have top-level project groups)
	// TODO: When nested projects are implemented, this may need to be recursive
