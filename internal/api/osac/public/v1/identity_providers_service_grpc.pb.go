...
type IdentityProvidersClient interface {
	...
	// Lists identity providers for the tenant.
	// Identity providers are scoped to a single organization via metadata.tenant.
...
var IdentityProviders_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "osac.public.v1.IdentityProviders",
	...
	Metadata: "osac/public/v1/identity_providers_service.proto",
}
